<template>
  <div class="team team-detail">
    ...
    <!-- 图片or视频 -->
    <div class="img-box">
      <video class="video" v-if="detailData.xs_post_type === '1' && detailData.img_dir" :src="baseUrl + detailData.img_dir" controls="controls">
        your browser does not support the video tag
      </video>
      <van-swipe v-if="detailData.xs_post_type === '2'" :autoplay="3000" indicator-color="#f29419" style="height: 200px;">
...
<script>
import { getXsDetail, getCmts, setZan, commentXs } from '@/api/classroom'
export default {
  computed: {
    userInfo () {
